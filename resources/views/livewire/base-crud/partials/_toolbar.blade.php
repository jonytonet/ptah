        ...
        <div class="inline-flex border rounded-md overflow-hidden ptah-c-btn" role="group" aria-label="{{ __('ptah::ui.btn_view_mode') }}">
            ...
            @if ($this->kanbanEnabled())
                <button wire:click="setViewMode('kanban')"
                    class="p-2 transition-colors ptah-c-control {{ $viewMode === 'kanban' ? 'ptah-c-btn_on' : '' }}"
                    title="{{ __('ptah::ui.view_mode_kanban') }}" aria-label="{{ __('ptah::ui.view_mode_kanban') }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            @if ($this->calendarEnabled())
                <button wire:click="setViewMode('calendar')"
                    class="p-2 transition-colors ptah-c-control {{ $viewMode === 'calendar' ? 'ptah-c-btn_on' : '' }}"
                    title="{{ __('ptah::ui.view_mode_calendar') }}" aria-label="{{ __('ptah::ui.view_mode_calendar') }}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
