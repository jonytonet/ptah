...
<div>
    ...
    <div class="ptah-module-toolbar flex flex-wrap items-center gap-2 px-4 py-3 mb-4 border rounded-md">
        <div class="flex-1 min-w-[180px] max-w-xs">
            <div class="relative">
                ...
                <input wire:model.live.debounce.300ms="search" type="search" placeholder="{{ __('ptah::ui.audit_search_ph') }}"
                    class="w-full py-2 pl-9 pr-4 text-sm rounded border border-slate-200 ptah-c-mod_field focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none transition-all"/>
            </div>
        </div>
        <select wire:model.live="filterResult"
            class="py-2 px-3 text-sm rounded border border-slate-200 ptah-c-mod_field focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none transition-all">
        ...
        <input wire:model.live="dateFrom" type="date"
            class="py-2 px-3 text-sm rounded border border-slate-200 dark:border-slate-600 ptah-c-mod_field dark:text-slate-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 dark:focus:border-blue-500 outline-none transition-all"
