...
<div>
    <div class="mb-5">
        <h1 class="text-2xl font-bold text-slate-800 ptah-page-title">Departamentos</h1>
        <p class="text-sm text-slate-500 mt-0.5">Agrupe perfis/roles por departamento.</p>
    </div>
    ...
    <div class="ptah-module-toolbar flex flex-wrap items-center gap-2 px-4 py-3 mb-4 border shadow-sm rounded-xl bg-white border-slate-200">
        ...
        <div class="flex-1 min-w-[180px] max-w-xs">
            <div class="relative">
                ...
                <input wire:model.live.debounce.300ms="search" type="search" placeholder="Buscar departamento..."
        ...
        <table class="w-full text-sm">
            <thead class="bg-slate-50 border-b-2 border-slate-200">
                <tr>
                    ...
                    <th class="px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500">Descrição</th>
                    <th class="px-3 py-3 text-center text-xs font-semibold uppercase tracking-wider text-slate-500">Roles</th>
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-slate-700">Nenhum departamento encontrado</p>
                                    <p class="text-xs mt-0.5 text-slate-400">Adicione o primeiro departamento</p>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <div x-data="{ open: @entangle('showDeleteModal').live }">
        <x-forge-modal title="Confirmar exclusão" size="sm">
            <p class="text-slate-600">Excluir este departamento? Roles vinculados perderão o departamento.</p>
            <x-slot name="footer">
                <x-forge-button color="light" @click="open = false">Cancelar</x-forge-button>
